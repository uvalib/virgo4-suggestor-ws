...
func InitializeService(cfg *serviceConfig) *ServiceContext {
	...
	if cfg.AI.Provider == "bedrock" {
		...
		aiProvider, err := providers.NewBedrockProvider(cfg.AI.Model, cfg.AI.KnowledgeBaseID, cfg.AI.ImagesKnowledgeBaseID, cfg.AI.BooksKnowledgeBaseID, cfg.AI.GuardrailID, cfg.AI.GuardrailVersion, httpClientWithTimeouts("10", "30"))
		if err != nil {
